...
loop:
	;define modo escrita no display
	acall  delay30ms
	mov	R7,#00000001b   ;(D7,D6,D5,D4, ,E,Rw,Rs) define o que envia
	acall	sendPCF
	mov	R7,#00000101b   ;(D7,D6,D5,D4, ,E,Rw,Rs) ativa o enable e envia o dado
	acall	sendPCF
	mov	R7,#00000001b   ;(D7,D6,D5,D4, ,E,Rw,Rs) desabilita o enable e completa o envio
	acall	sendPCF
	;inverte os nibbles
	acall  delay30ms
